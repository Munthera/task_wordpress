...
final class magicalProductsDisplay
{
	...
	public function init()
	{
		...
		//Check pro version
		if (in_array('magical-products-display-pro/magical-products-display-pro.php', apply_filters('active_plugins', get_option('active_plugins'))) && get_option('mgppro_has_valid_lic') == 'yes') {
